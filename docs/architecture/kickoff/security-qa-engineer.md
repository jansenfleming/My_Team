...
- Workflow: PR file `docs/prs/<slug>.md` for your own branches; Architect reviews and merges. Never push or touch the `origin` remote. Commit messages end with the attribution line from your harness instructions.
